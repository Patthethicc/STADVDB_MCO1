...
export const createUser = async (data) => {
  ...
  try {
    ...
    // Attempt to also write the fragment (SLAVE 06 or SLAVE 07) so shards stay in sync.
    // Per spec: master should accept writes even if fragment update fails; rely on recovery service.
    try {
